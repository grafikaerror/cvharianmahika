<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">List Tampilan About</h6>
        </div>
        <div class="card-body">
                    ...
                    <tbody>
                        <?php foreach ($tampilanhome as $home) : ?>
                            <tr>
                                ...
                                <td>
                                    <a href="<?= base_url('admin/editTampilanAbout/') ?><?= $home['id_tampilan'] ?>" class="btn btn-info" title="Edit"><i class="fas fa-pen"></i></a>
                                </td>
