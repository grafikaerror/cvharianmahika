    <div class="container-fluid">
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                <div class="card border-left-danger shadow h-100 py-2">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-danger text-uppercase mb-1">Jumlah Promo</div>
                                <a class="btn btn-outline-danger my-3" href="<?= base_url('admin/listPromo'); ?>">LIHAT</a>
        ...
        <div class="alert alert-primary" role="alert">
            <h3 class="my-auto">Tips Untuk Admin</h3>
        </div>
                        ...
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="h5 mb-0 font-weight-bold text-gray-800">
                                    <a href="#" class="text-danger">Mengisi Field Gambar</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card border-left-danger shadow h-100 py-2">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="h5 mb-0 font-weight-bold text-gray-800">
                                    <a href="#" class="text-danger">Menambah Perumahan</a>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="row no-gutters align-items-center">
                                    <div class="col-auto">
                                        <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">
                                            <a href="#" class="text-danger">Menambah Tipe per-Perumahan</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="card border-left-danger shadow h-100 py-2">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="h5 mb-0 font-weight-bold text-gray-800">
                                    <a href="#" class="text-danger">Membuat Artikel Baru</a>
                                </div>
                            </div>
                        </div>
                    </div>
